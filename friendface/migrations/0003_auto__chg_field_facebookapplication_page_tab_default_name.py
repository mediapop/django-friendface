...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FacebookApplication.page_tab_default_name'
        db.alter_column('friendface_facebookapplication', 'page_tab_default_name', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'FacebookApplication.page_tab_default_name'
        db.alter_column('friendface_facebookapplication', 'page_tab_default_name', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
