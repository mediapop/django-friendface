...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FacebookApplication.created_time'
        db.delete_column('friendface_facebookapplication', 'created_time')


    def backwards(self, orm):
        # Adding field 'FacebookApplication.created_time'
        db.add_column('friendface_facebookapplication', 'created_time',
    ...
    models = {
        'friendface.facebookapplication': {
            ...
            'access_token_updated_at': ('model_utils.fields.MonitorField', [], {'default': 'datetime.datetime.now', 'null': 'True', u'monitor': "'access_token'", 'blank': 'True'}),
