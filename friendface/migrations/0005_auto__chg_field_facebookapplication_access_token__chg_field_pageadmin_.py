...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FacebookApplication.access_token'
        db.alter_column('friendface_facebookapplication', 'access_token', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'PageAdmin.access_token'
        db.alter_column('friendface_pageadmin', 'access_token', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'FacebookUser.access_token'
        db.alter_column('friendface_facebookuser', 'access_token', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'FacebookApplication.access_token'
        db.alter_column('friendface_facebookapplication', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'PageAdmin.access_token'
        db.alter_column('friendface_pageadmin', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'FacebookUser.access_token'
        db.alter_column('friendface_facebookuser', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
