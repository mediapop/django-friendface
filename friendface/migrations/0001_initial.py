...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('friendface_facebookuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('uid', self.gf('django.db.models.fields.BigIntegerField')()),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['friendface.FacebookApplication'])),
            ...
            ('timezone', self.gf('django.db.models.fields.IntegerField')(max_length=100, null=True, blank=True)),
            ('religion', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('locale', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('gender', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('access_token', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
        ))
        db.send_create_signal('friendface', ['FacebookUser'])

        # Adding unique constraint on 'FacebookUser', fields ['uid', 'application']
        db.create_unique('friendface_facebookuser', ['uid', 'application_id'])

        # Adding model 'FacebookAuthorization'
        db.create_table('friendface_facebookauthorization', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['friendface.FacebookApplication'])),
            ...
            ('next', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('friendface', ['FacebookAuthorization'])

        # Adding model 'FacebookApplication'
        db.create_table('friendface_facebookapplication', (
            ...
            ('default_scope', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('access_token', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('namespace', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=23, null=True, blank=True)),
            ('subcategory', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('company', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ...
            ('daily_active_users', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('weekly_active_users', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('monthly_active_users', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('auth_dialog_data_help_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('auth_dialog_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('auth_dialog_headline', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('auth_dialog_perms_explanation', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('auth_referral_default_activity_privacy', self.gf('django.db.models.fields.CharField')(max_length=11, null=True, blank=True)),
            ('auth_referral_enabled', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('auth_referral_extended_perms', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True)),
            ('canvas_fluid_height', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('canvas_fluid_width', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('canvas_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('contact_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('created_time', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('deauth_callback_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('iphone_app_store_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('hosting_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('mobile_web_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('page_tab_default_name', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('page_tab_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('privacy_policy_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('secure_canvas_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('secure_page_tab_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('social_discovery', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('terms_of_service_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('user_support_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('user_support_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('website_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('friendface', ['FacebookApplication'])

        # Adding model 'FacebookTab'
        db.create_table('friendface_facebooktab', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['friendface.FacebookApplication'])),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['friendface.FacebookPage'])),
        ))
        db.send_create_signal('friendface', ['FacebookTab'])

        # Adding model 'FacebookInvitation'
        db.create_table('friendface_facebookinvitation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('request_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['friendface.FacebookApplication'])),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='facebookinvitations_sent', to=orm['friendface.FacebookUser'])),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='facebookinvitations_received', to=orm['friendface.FacebookUser'])),
            ('accepted', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('next', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('friendface', ['FacebookInvitation'])

        # Adding unique constraint on 'FacebookInvitation', fields ['request_id', 'receiver']
        db.create_unique('friendface_facebookinvitation', ['request_id', 'receiver_id'])

        # Adding model 'FacebookPage'
        db.create_table('friendface_facebookpage', (
            ('id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('likes', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('talking_about_count', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('name_space', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('is_published', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal('friendface', ['FacebookPage'])


    def backwards(self, orm):
        # Removing unique constraint on 'FacebookInvitation', fields ['request_id', 'receiver']
        db.delete_unique('friendface_facebookinvitation', ['request_id', 'receiver_id'])

        # Removing unique constraint on 'FacebookUser', fields ['uid', 'application']
        db.delete_unique('friendface_facebookuser', ['uid', 'application_id'])

        # Deleting model 'FacebookUser'
        db.delete_table('friendface_facebookuser')

        # Deleting model 'FacebookAuthorization'
        db.delete_table('friendface_facebookauthorization')

        # Deleting model 'FacebookApplication'
        db.delete_table('friendface_facebookapplication')

        # Deleting model 'FacebookTab'
        db.delete_table('friendface_facebooktab')

        # Deleting model 'FacebookInvitation'
        db.delete_table('friendface_facebookinvitation')

        # Deleting model 'FacebookPage'
        db.delete_table('friendface_facebookpage')
    ...
    models = {
        'friendface.facebookapplication': {
            ...
            'auth_dialog_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
