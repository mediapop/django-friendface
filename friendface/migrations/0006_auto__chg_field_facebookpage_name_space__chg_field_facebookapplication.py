...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FacebookPage.name_space'
        db.alter_column('friendface_facebookpage', 'name_space', self.gf('django.db.models.fields.CharField')(max_length=22, null=True))

        # Changing field 'FacebookApplication.namespace'
        db.alter_column('friendface_facebookapplication', 'namespace', self.gf('django.db.models.fields.CharField')(max_length=22, null=True))

    def backwards(self, orm):

        # Changing field 'FacebookPage.name_space'
        db.alter_column('friendface_facebookpage', 'name_space', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'FacebookApplication.namespace'
        db.alter_column('friendface_facebookapplication', 'namespace', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
